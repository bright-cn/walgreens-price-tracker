...
[![Walgreens Price Tracker](https://img.shields.io/badge/Walgreens%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/walgreens)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/walgreens)

实时 Walgreens 价格跟踪——美国第二大连锁药房。两种入门方式：**全托管**情报平台，或用于构建您自有 pipeline 的**自助式 API**。

---

## 选项 1：Bright Insights - AI 驱动的价格跟踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/walgreens)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到仪表板、数据 feed 或您的 BI 工具中。
...
> **每月 $250 起 - [获取定制报价 →](https://bright.cn/products/insights/price-tracker/walgreens)**

---

## 选项 2：通过 Web Scraper API 自助使用

更希望构建您自己的 pipeline？Bright Data 的 **Web Scraper API** 为您提供对 Walgreens 产品数据的编程访问——包括价格、可用性、评论等——无需管理代理或抓取基础设施。
...
- 一个用于 Walgreens 产品的 Bright Data **Web Scraper ID**（[在 Web Scrapers 控制面板中找到它](https://bright.cn/cp/scrapers)）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/walgreens-price-tracker.git
...
3. **配置凭证**
   ...
   > 搜索 “Walgreens”，并复制 Web Scraper ID（格式：`gd_xxxxxxxxxxxx`）。
...
传入 Walgreens 产品 URL 列表以获取结构化价格数据：
...
- 🌟 [Walgreens Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/walgreens)
- 🔧 [Walgreens Scraper API](https://bright.cn/products/web-scraper/walgreens)
